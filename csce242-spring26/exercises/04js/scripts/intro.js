...
/* thermometer */
const GOAL = 10000;
const goal = document.getElementById("don-goal").innerHTML = GOAL;
document.getElementById("btn-donation").onclick = () => {
    const donation = parseInt(document.getElementById("txt-donation").value);
    percent = donation / GOAL*100;
    document.getElementById("p-donation-message").innerHTML = `You are ${percent.toFixed(1)}% to ur goal`;
